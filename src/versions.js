...
export const appChangelog = {
	...
	'v0.12.x': {
		...
		Changes: ['Added a button to toggle build mode, hiding the (+) UI until buid mode is active', 'Fixed performance issues from new person node connection lines and hover from 0.11']
	},
	'v0.11.x': {
